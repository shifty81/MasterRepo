...
public:
    ...
    BuildResult Compile(const std::string& target = "");
    BuildResult RunCMake(const std::string& buildDir, const std::string& sourceDir = ".");
    BuildResult RunTests(const std::string& filter = "");
    std::vector<std::string> CheckErrors(const std::string& output);
