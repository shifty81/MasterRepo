...
public:
    ...
    bool RenameSymbol(const std::string& filePath, const std::string& oldName, const std::string& newName);
    bool ExtractFunction(const std::string& filePath, int startLine, int endLine, const std::string& funcName);
    bool MoveFile(const std::string& srcPath, const std::string& dstPath);
    bool UpdateIncludes(const std::string& oldPath, const std::string& newPath);
